...
- FK detection: oltre ai suffissi nome, fase value-overlap in `build_from_schema` (campiona valori, confronta con PK-candidate) → join con nomi diversi e cross-source; bounded + gated da `FRA_KG_FK_VALUE_SCAN`
