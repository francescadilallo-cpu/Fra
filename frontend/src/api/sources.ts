...
export const CONNECTOR_BACKEND_MAP: Record<string, ConnectorBackendDef> = {
  ...
  salesforce: {
    ...
    params_schema: [
      ...
      {
        key: 'objects',
        label: 'Objects to sync (optional)',
        type: 'text',
        placeholder: 'Account, Opportunity, MyObject__c',
        required: false,
        hint: 'Comma-separated object API names. Leave empty for the default: standard business objects + all your custom objects.',
      },
    ],
  },
